...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, DialogModule, ButtonModule, InputTextModule, CheckboxModule, ForwardPipePipe],
...
export class AddAdminComponentComponent implements OnInit {
  ...
  constructor(public forwardFormService : ForwardServiceService,
